...
def map_abilities(id):
    ability_map = {
        ...
        "A1a-006": "Jungle Totem: Each Grass Energy attached to your Grass Pokémon provides 2 Grass Energy. This effect doesn't stack.",
        "A1a-070": "Jungle Totem: Each Grass Energy attached to your Grass Pokémon provides 2 Grass Energy. This effect doesn't stack.",
        "A1a-019": "Wash Out: As often as you like during your turn, you may move a Water Energy from 1 of your Benched Water Pokémon to your Active Water Pokémon.",
        "A1a-072": "Wash Out: As often as you like during your turn, you may move a Water Energy from 1 of your Benched Water Pokémon to your Active Water Pokémon.",
        "A1a-046": "Primeval Law: Your opponent can't play any Pokémon from their hand to evolve their Active Pokémon.",
        "A1a-078": "Primeval Law: Your opponent can't play any Pokémon from their hand to evolve their Active Pokémon.",
        "A1a-084": "Primeval Law: Your opponent can't play any Pokémon from their hand to evolve their Active Pokémon.",
        "A1a-056": "Rough Skin: If this Pokémon is in the Active Spot and is damaged by an attack from your opponent's Pokémon, do 20 damage to the Attacking Pokémon.",
    }
    return ability_map.get(id, None)
...
def transform_card(card):
    ...
    return {
        "id": card["id"],
        "name": card["name"],
        "hp": int(card["hp"]) if card["hp"] != "0" else None,
        "retreatCost": int(card["retreat"]) if card["retreat"] else None,
        ...
        "hasAbility": card["ability"] is not None,
        "ability": map_abilities(card["id"]),
        "trainerCardText": card["text"] if card["type"] != "Pokemon" else None,
        "rarity": card["rarity"],
        "superType": "Trainer" if card["type"] != "Pokemon" else "Pokémon",
        "subTypes": [card["stage"]] + (["ex"] if " ex" in card["name"] else []),
        "expansionId": "PROMOA" if card["dex"] != "A1a" else card["dex"],
        "energyTypes": [card["color"]],
        ...
        "foundInPacks": ["PA1-3" if card["dex"] == "PROMOA3" else card["dex"]],
        "dustCost": None,  # Added based on provided data
    }
